...
class Fighter():
    def __init__(self , player, x, y, flip ,data,sprite_sheet,animation_steps, sound):
        ...
        self.action = 0# 0:idle 1:run 2:jump 3:attack 4:attack 2 5:hit 6:death
        self.frame_index = 0
    ...
    def move(self , screen_width, screen_height , surface , target , round_over):
        ...
        #can only perform other actions
        ...
        #ensure the player stay on screen
    ...
    def update_action (self , new_action):
        # check if action is different from previous one
